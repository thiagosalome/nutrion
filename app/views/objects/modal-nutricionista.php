    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="js-form-updateNutritionist" action="<?php echo HOME_URI; ?>nutricionista/update">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form role="form" class="js-form-deleteNutritionist" action="<?php echo HOME_URI; ?>nutricionista/delete">
                    <input type="hidden" name="id_nutricionista" value="<?php echo $_SESSION['id_nutricionista']; ?>">
